...
export const slides: SlideData[] = [
  ...
  },
  {
    ...
    leftColumn: [
      ...
      "**Browser**: Can control Chrome to test and interact with websites",
    ],
    rightColumn: [
      "⚠️ Good to Know",
      "Works as a **CLI** in the terminal or as a **GUI** in VS Code, JetBrains, and the Claude Desktop app",
  ...
  },
  {
    ...
    rightColumn: [
      "⚠️ When In Doubt",
      "Ask Claude to **explain** what a command does before approving",
      "You can always say **no** — Claude will find another way",
    ],
    bgColor: "bg-brutal-yellow",
    layout: "two-column",
    transition: "slide",
  },
  {
    ...
    leftColumn: [
      "✅ DO",
      "Describe triggers, actions, and expected results",
      "Reference existing files and patterns by name",
      "Paste screenshots — a picture is worth 1000 words",
    ],
    rightColumn: [
      "❌ DON'T",
      "Be vague ('make it better', 'fix the bug')",
      "Cram multiple unrelated tasks into one prompt",
      "Skip the planning step — always plan before coding",
    ],
    bgColor: "bg-brutal-yellow",
    layout: "two-column",
  },
  ...
  },
  {
    ...
    bullets: [
      "Go to **vibe-coding-website-woad.vercel.app**",
